...
- always-on read-only main-runtime metadata PVs for the running release version and git revision:
  `<server.instance>:version`, `<server.instance>:revision`, `SYS:<server.instance>:version`, and
  `SYS:<server.instance>:revision`
