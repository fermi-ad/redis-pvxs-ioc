# Historical Redis PVXS IOC Design Proposal

> **Status:** Historical design input from the initial product phase. This file
> contains aspirational language and obsolete schema examples; it is not the
> current runtime contract. See [`../design.md`](../design.md) for the implemented
> architecture and [`../configuration.md`](../configuration.md) for the supported
> YAML schema.
