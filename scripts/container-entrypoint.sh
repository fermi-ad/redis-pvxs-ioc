...
export EPICS_HOST_INTERFACE="${EPICS_HOST_INTERFACE:-eth1}"
...
export EPICS_PVA_ADDR_LIST="${EPICS_PVA_ADDR_LIST:-239.128.1.6,8@${EPICS_HOST_INTERFACE} 239.128.1.6}"
...
exec /opt/redis-pvxs-ioc/bin/redis-pvxs-ioc "$@"
